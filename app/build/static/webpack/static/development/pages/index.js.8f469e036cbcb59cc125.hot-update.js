...
var options; // TODO - put drop down select with test trials loaded
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                response = (_readOnlyError("response"), response.map(function (trial) {
                  return {
                    value: trial,
                    label: trial
                  };
                }));
                console.log('set selectOptions', response);
...
//# sourceMappingURL=index.js.8f469e036cbcb59cc125.hot-update.js.map